...
namespace Sannel.House.Base.Data
{
	public static class Extensions
	{
			...
			where T : DbContext
		{
			...
			builder.Services.AddTransient(p => new DbHealthCheck<T>(p, queryAsync));
			...
			where T : DbContext
		{
			...
			builder.Services.AddTransient(p => new DbHealthCheck<T>(p, queryAsync, degradedThreshold));
			return builder.AddCheck<DbHealthCheck<T>>(name);
		}
	}
}
